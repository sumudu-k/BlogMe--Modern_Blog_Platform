...
$pageTitle = 'Home';
$pageDescription = 'Discover amazing blog posts and stories';
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100 border-0 shadow-sm hover-shadow">
                    ...
                    <img src="./assets/images/<?= $blog['featured_image']; ?>" class="card-img-top"
                        style="height: 200px; object-fit: cover;" alt="<?php echo htmlspecialchars($blog['title']); ?>">
                    <?php endif; ?>
    ...
    <nav aria-label="Blog pagination" class="mt-5">
        <ul class="pagination justify-content-center">
            ...
            <?php
                    ...
                    if ($startPage > 1): ?>
            <li class="page-item">
                <a class="page-link" href="?page=1<?php echo $categoryId ? '&category=' . $categoryId : ''; ?>">1</a>
            </li>
            <?php if ($startPage > 2): ?>
...
.hero-section {
    background: linear-gradient(135deg, var(--bs-primary) 0%, s0056b3 100%);
}
